...
// so page.tsx shouldn't need any changes once this is wired up.

function fakeWeatherFor(city: string): WeatherResponse {
  // deterministic-ish "random" so refreshing the same city doesn't jump around
  const seed = city
    .toLowerCase()
    .split("")
